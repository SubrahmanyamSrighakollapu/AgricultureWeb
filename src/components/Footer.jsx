        ...
        <footer className="w-100" role="contentinfo">
                ...
                <div className="container">
                    <div className="row justify-content-center" style={{ maxWidth: '70rem', margin: '0 auto' }}>
                        ...
                        <div className="col-lg-2 col-12 mb-4">
                            ...
                            <img src={divider} alt="" className="d-block mx-lg-0 mx-auto mb-3 divider" />
                        ...
                        <div className="col-lg-3 col-12 mb-4">
                            ...
                            <div className="d-flex gap-2" style={{ marginTop: '1rem' }}>
                                <input
                                    ...
                                    style={{ height: '3.125rem', borderRadius: '0.625rem', maxWidth: '18rem' }}
                                />
                                <button className="btn" style={{ background: '#4BAF47', borderRadius: '0.625rem', width: '3rem', height: '3.125rem', display: 'inline-flex', alignItems: 'center', justifyContent: 'center' }}>
            ...
            <div style={{ background: '#1F1E17' }}>
                <div className="container">
                    <div className="d-flex justify-content-between align-items-center py-3 flex-column flex-md-row">
                        ...
                        <p style={{ color: '#A5A49A', margin: 0, textAlign: 'right' }}>Terms of Use  |  Privacy Policy  |  Refund policy</p>
                    </div>
                </div>
            </div>
            ...
            <style>{`
                ...
                @media (max-width: 992px) {
                    /* On smaller screens, ensure divider centers and is shown under each title */
                    .divider { display: flex; align-items: left; margin-left: 0; }
                }
                @media (max-width: 768px) {
                    .location-input { max-width: 16rem; }
                }
                @media (max-width: 480px) {
                    .location-input { max-width: 15rem; }
