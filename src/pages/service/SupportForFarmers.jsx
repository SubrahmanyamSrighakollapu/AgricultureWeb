                ...
                <div className="row agent-row align-items-center g-2">
                    ...
                    <div className="col-lg-6">
                        <div className="agent-left">
                            <h2 className="section-title mb-2">Credit & Financial Support for Farmers</h2>
                            <p className="section-desc mb-0">We bridge the gap between farmers and fair capital. Our platform offers tailored financial products designed specifically for the agricultural cycle, ensuring farmers have resources when they need them most.</p>
